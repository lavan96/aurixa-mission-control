...
export function YggdrasilTree({ clones, primeName }: Props) {
  ...
  return (
    <div ref={containerRef} className="relative w-full overflow-hidden rounded-xl border border-border/40 bg-background">
