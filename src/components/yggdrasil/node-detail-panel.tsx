 ...
 * selected clone node on the tree.
 */

import { motion } from "framer-motion";
import { Link } from "@tanstack/react-router";
import { X, GitBranch, ExternalLink, Github } from "lucide-react";
...
export function YggdrasilNodePanel({ node, onClose }: Props) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="mt-4 space-y-3">
        <div className="flex items-center gap-2">
          <StatusPill status={node.syncStatus} behind={node.commitsBehind} />
